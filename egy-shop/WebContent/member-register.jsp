            ...
            <form class="row contact_form" action="member-register.do" method="post" novalidate="novalidate">
              ...
              <div class="col-md-12 form-group p_star">
                <select class="country_select" style="display: none;">
                  ...
                  <option value="2">스페인</option>
                  <option value="4">핀란드</option>
                </select><div class="nice-select country_select" tabindex="0"><span class="current">Country</span><ul class="list"><li data-value="1" class="option selected focus">한국</li><li data-value="2" class="option">스페인</li><li data-value="4" class="option">핀란드</li></ul></div>
 			</div>
            <div class="col-md-12 form-group p_star">			     
...
Copyright ©<script>document.write(new Date().getFullYear());</script>20192019 All rights reserved | This template is made with <i class="ti-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a>
